...
if [ "$ACTUAL" = "$EXPECTED" ]; then
    echo "PASS scrip(.sc) smoke: ... + qize-empty-OK + qize-plain-OK + sqize-OK + dqize-OK + sqlsqize-OK + tdump-quote-OK + infra7a-inline-assign-OK + infra7a-qize-tab-OK + trace-silent-OK"
    exit 0
fi
