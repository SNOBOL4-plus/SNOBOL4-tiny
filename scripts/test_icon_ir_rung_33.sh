#!/usr/bin/env bash
# test_icon_ir_rung_33.sh — rung33: case expressions — IC-7
...
echo "=== rung33: case expressions ==="
run rung33_case_case_arith
run rung33_case_case_in_proc
run rung33_case_case_int
run rung33_case_case_no_default
run rung33_case_case_str
