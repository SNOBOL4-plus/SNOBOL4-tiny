...
extern DESCR_t EXTVAL;    /* [V3.11] = EXTSIZ*2*DESCR                     */
...
extern DESCR_t AREFN,BASEFN,CMAFN,ENDAFN,ENDFN,ERORFN,FNTRFN,FXTRFN,GOTGFN,GOTLFN,GOTOFN,INITFN,KEYTFN,LABTFN,LITFN,VLTRFN;
