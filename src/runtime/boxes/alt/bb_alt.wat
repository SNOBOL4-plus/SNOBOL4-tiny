;; bb_alt.wat — Dynamic Byrd Box: ALT
...
;; bb_alt: composite — α/β in sno_engine.wat
  (func $bb_alt_a (export "bb_alt_a") (param $p0 i32)(param $p1 i32)(param $s i32)(result i32) (i32.const -1))
  (func $bb_alt_b (export "bb_alt_b") (param $p0 i32)(param $p1 i32)(param $s i32)(result i32) (i32.const -1))
)
