;; bb_capture.wat — Dynamic Byrd Box: CAPTURE
...
;; bb_capture: composite — α/β in sno_engine.wat
  (func $bb_capture_a (export "bb_capture_a") (param $p0 i32)(param $p1 i32)(param $s i32)(result i32) (i32.const -1))
  (func $bb_capture_b (export "bb_capture_b") (param $p0 i32)(param $p1 i32)(param $s i32)(result i32) (i32.const -1))
)
