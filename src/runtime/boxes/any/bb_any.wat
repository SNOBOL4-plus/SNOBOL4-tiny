;; bb_any.wat — Dynamic Byrd Box: ANY
...
(module
  ...
  ;; bb_any_a: if Δ>=Ω or Σ[Δ] not in chars → -1; Δ++; return 1
  ;; bb_any_b: Δ--; return -1
  ;; params: chars_ptr(i32) [unused] [unused]
  (func $strchr_any (param $ptr i32) (param $c i32) (result i32)
    (local $ch i32)
    (block $found
      (block $notfound
        (loop $scan
