;; bb_brk.wat — Dynamic Byrd Box: BRK
...
(module
  ...
  ;; bb_brk_a: scan while NOT in chars; if Δ+δ>=Ω → -1; Δ+=δ; return δ
  ;; bb_brk_b: Δ-=saved; return -1
  (func $strchr_bk (param $ptr i32) (param $c i32) (result i32)
    (local $ch i32)
  ...
  (func $bb_brk_a (export "bb_brk_a")
    ...
    (block $done (loop $scan
      ...
      (br_if $done (call $strchr_bk (local.get $chars_ptr)
