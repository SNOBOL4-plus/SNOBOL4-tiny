...
/*----------------------------------------------------------------------------------------------------------------------------
 * coro_bb_alternate — E_ALTERNATE Byrd box (IC-2a)
 *
...
/*----------------------------------------------------------------------------------------------------------------------------
 * coro_bb_limit — E_LIMIT Byrd box  (gen \ N)   IC-2b
 *
...
/*----------------------------------------------------------------------------------------------------------------------------
 * coro_bb_every — E_EVERY Byrd box  (every gen [do body])   IC-2b
 *
...
/*----------------------------------------------------------------------------------------------------------------------------
 * coro_bb_bang_binary — E_BANG_BINARY Byrd box  (E1 ! E2)   IC-2b
 *
...
/*----------------------------------------------------------------------------------------------------------------------------
 * coro_bb_seq_expr — E_SEQ_EXPR Byrd box  (E1; E2; …; En)   IC-2b
 *
