...
#
# Usage: bash /home/claude/one4all/build/build_setup.sh
...
bash "$ONE4ALL/build/build_packages.sh"

# ── 3. scrip ─────────────────────────────────────────────────────────────────
bash "$ONE4ALL/build/build_scrip.sh"

# ── 4. SPITBOL x64 oracle ────────────────────────────────────────────────────
if [ -d "$ROOT/x64/.git" ]; then
    bash "$ONE4ALL/build/build_spitbol.sh"
else
...
if [ -d "$ROOT/csnobol4/.git" ]; then
    bash "$ONE4ALL/build/build_csnobol4.sh"
else
