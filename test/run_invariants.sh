...
run_snobol4_wasm() {
  ...
  local DIRS="hello rung4 rung3 rung2 rung8 rung9 rungW01 rungW02 rungW03 rungW04 rungW05 rungW06 rungW07 rung11"
  for dir in $DIRS; do
...
run_snocone_x86() {
  ...
  local DIRS="rungA01 rungA02 rungA03 rungA04 rungA05 rungA06 rungA07 rungA08 rungA09 rungA10 rungA11 rungA12 rungA13 rungA14 rungA15 rungA16 rungB01 rungB02 rungB03 rungB04 rungB05 rungB06 rungB07 rungB08 rungB09"
  local dir_args=()
  for d in $DIRS; do
