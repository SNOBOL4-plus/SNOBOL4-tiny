...
.class public _014_func_freturn
...
.method static <clinit>()V
    ...
    putstatic       _014_func_freturn/sno_stdout Ljava/io/PrintStream;
    iconst_0
    putstatic       _014_func_freturn/sno_kw_TRIM I
    iconst_0
    putstatic       _014_func_freturn/sno_kw_ANCHOR I
    iconst_0
    putstatic       _014_func_freturn/sno_kw_STNO I
    iconst_m1
    putstatic       _014_func_freturn/sno_kw_STLIMIT I
    iconst_0
    putstatic       _014_func_freturn/sno_kw_STCOUNT I
    new java/util/HashMap
    dup
    invokespecial java/util/HashMap/<init>()V
    putstatic       _014_func_freturn/sno_vars Ljava/util/HashMap;
    new java/util/HashMap
    dup
    invokespecial java/util/HashMap/<init>()V
    putstatic       _014_func_freturn/sno_arrays Ljava/util/HashMap;
    new java/util/HashMap
    dup
    invokespecial java/util/HashMap/<init>()V
    putstatic       _014_func_freturn/sno_data_types Ljava/util/HashMap;
    return
.end method
...
.method static sno_mon_init()V
    ...
    putstatic _014_func_freturn/sno_mon_fd Ljava/io/OutputStream;
    ldc "MONITOR_GO_PIPE"
    invokestatic java/lang/System/getenv(Ljava/lang/String;)Ljava/lang/String;
    astore_1
    aload_1
    ...
    putstatic _014_func_freturn/sno_mon_go_fd Ljava/io/InputStream;
Lsmi_done:
    return
.end method
...
.method public static main([Ljava/lang/String;)V
    ...
    invokestatic _014_func_freturn/sno_mon_init()V
    getstatic _014_func_freturn/sno_kw_STNO I
    iconst_1
    iadd
    putstatic _014_func_freturn/sno_kw_STNO I
    invokestatic _014_func_freturn/sno_stcount_tick()V
    ldc ""
    pop
    goto L_af_end
; === af_end ==========================================================
L_af_end:
    ...
    putstatic _014_func_freturn/sno_kw_STNO I
    invokestatic _014_func_freturn/sno_stcount_tick()V
    invokestatic _014_func_freturn/sno_userfn_always_fail()Ljava/lang/String;
    dup
    ifnonnull Lef_nn_0
    pop
    goto L_e001
...
Lef_dn_0:
    ...
    putstatic _014_func_freturn/sno_kw_STNO I
    invokestatic _014_func_freturn/sno_stcount_tick()V
    ldc "FAIL 1014/001: freturn should cause statement failure"
    dup
    ifnonnull Lout_ok_0
    pop
    goto Lout_fail_0
Lout_ok_0:
    getstatic _014_func_freturn/sno_stdout Ljava/io/PrintStream;
    swap
...
L_e001:
    ...
    putstatic _014_func_freturn/sno_kw_STNO I
    invokestatic _014_func_freturn/sno_stcount_tick()V
    ldc "PASS 1014_func_freturn (1/1)"
    dup
    ifnonnull Lout_ok_1
    pop
    goto Lout_fail_1
...
; program end
    return
.end method
.method static sno_userfn_always_fail()Ljava/lang/String;
    .limit stack 16
    .limit locals 64
...
Lkwg_not_stno:
    ...
    invokevirtual java/lang/String/equalsIgnoreCase(Ljava/lang/String;)Z
    ifeq Lkwg_not_trim
    getstatic _014_func_freturn/sno_kw_TRIM I
    invokestatic java/lang/Integer/toString(I)Ljava/lang/String;
    areturn
Lkwg_not_trim:
    aload_0
    ...
    getstatic _014_func_freturn/sno_kw_ANCHOR I
    invokestatic java/lang/Integer/toString(I)Ljava/lang/String;
    areturn
Lkwg_not_anchor:
    aload_0
    ...
    getstatic _014_func_freturn/sno_kw_STLIMIT I
    invokestatic java/lang/Integer/toString(I)Ljava/lang/String;
    areturn
Lkwg_not_stlimit:
    aload_0
    ...
    getstatic _014_func_freturn/sno_kw_STCOUNT I
    invokestatic java/lang/Integer/toString(I)Ljava/lang/String;
    areturn
Lkwg_not_stcount:
    ldc ""
...
.method static sno_var_put(Ljava/lang/String;Ljava/lang/String;)V
    ...
    return
Lsvp_not_output:
    getstatic _014_func_freturn/sno_vars Ljava/util/HashMap;
    aload_0
    aload_1
    ...
    aload_0
    aload_1
    invokestatic _014_func_freturn/sno_mon_var(Ljava/lang/String;Ljava/lang/String;)V
    return
.end method
...
.method static sno_mon_var(Ljava/lang/String;Ljava/lang/String;)V
    .limit stack 6
    .limit locals 3
    getstatic _014_func_freturn/sno_mon_fd Ljava/io/OutputStream;
    ifnull Lsmv_done
    new java/lang/StringBuilder
    dup
    invokespecial java/lang/StringBuilder/<init>()V
    ...
    getstatic _014_func_freturn/sno_mon_go_fd Ljava/io/InputStream;
    ifnull Lsmv_done
    getstatic _014_func_freturn/sno_mon_go_fd Ljava/io/InputStream;
