...
.method static <clinit>()V
    ...
    putstatic       _018_apply/sno_stdout Ljava/io/PrintStream;
    iconst_0
    putstatic       _018_apply/sno_kw_TRIM I
    iconst_0
    putstatic       _018_apply/sno_kw_ANCHOR I
    iconst_0
    putstatic       _018_apply/sno_kw_STNO I
    iconst_m1
    putstatic       _018_apply/sno_kw_STLIMIT I
    iconst_0
    putstatic       _018_apply/sno_kw_STCOUNT I
    new java/util/HashMap
    dup
    invokespecial java/util/HashMap/<init>()V
    putstatic       _018_apply/sno_vars Ljava/util/HashMap;
    new java/util/HashMap
    dup
    invokespecial java/util/HashMap/<init>()V
    putstatic       _018_apply/sno_arrays Ljava/util/HashMap;
    new java/util/HashMap
    dup
    invokespecial java/util/HashMap/<init>()V
    putstatic       _018_apply/sno_data_types Ljava/util/HashMap;
    return
.end method
...
.method static sno_mon_init()V
    ...
    putstatic _018_apply/sno_mon_fd Ljava/io/OutputStream;
    ldc "MONITOR_GO_PIPE"
    invokestatic java/lang/System/getenv(Ljava/lang/String;)Ljava/lang/String;
    astore_1
    aload_1
    ...
    putstatic _018_apply/sno_mon_go_fd Ljava/io/InputStream;
Lsmi_done:
    return
.end method
...
.method public static main([Ljava/lang/String;)V
    ...
    invokestatic _018_apply/sno_mon_init()V
    getstatic _018_apply/sno_kw_STNO I
    iconst_1
    iadd
    putstatic _018_apply/sno_kw_STNO I
    invokestatic _018_apply/sno_stcount_tick()V
    ldc ""
    dup
    ifnonnull Lef_nn_0
    pop
...
Lef_dn_0:
    ...
    putstatic _018_apply/sno_kw_STNO I
    invokestatic _018_apply/sno_stcount_tick()V
    ldc "FAIL 1018/001: apply(.eq,1,2) should fail"
    dup
    ifnonnull Lout_ok_0
    pop
    goto Lout_fail_0
Lout_ok_0:
    getstatic _018_apply/sno_stdout Ljava/io/PrintStream;
    swap
...
Lef_dn_1:
    ...
    putstatic _018_apply/sno_kw_STNO I
    invokestatic _018_apply/sno_stcount_tick()V
    ldc "FAIL 1018/002: apply(.eq,1,1) should succeed"
    dup
    ifnonnull Lout_ok_1
    pop
    goto Lout_fail_1
...
Lkwg_not_stno:
    ...
    invokevirtual java/lang/String/equalsIgnoreCase(Ljava/lang/String;)Z
    ifeq Lkwg_not_trim
    getstatic _018_apply/sno_kw_TRIM I
    invokestatic java/lang/Integer/toString(I)Ljava/lang/String;
    areturn
Lkwg_not_trim:
    aload_0
    ...
    getstatic _018_apply/sno_kw_ANCHOR I
    invokestatic java/lang/Integer/toString(I)Ljava/lang/String;
    areturn
Lkwg_not_anchor:
    aload_0
    ...
    getstatic _018_apply/sno_kw_STLIMIT I
    invokestatic java/lang/Integer/toString(I)Ljava/lang/String;
    areturn
Lkwg_not_stlimit:
    aload_0
    ...
    getstatic _018_apply/sno_kw_STCOUNT I
    invokestatic java/lang/Integer/toString(I)Ljava/lang/String;
    areturn
Lkwg_not_stcount:
    ldc ""
...
.method static sno_var_put(Ljava/lang/String;Ljava/lang/String;)V
    ...
    return
Lsvp_not_output:
    getstatic _018_apply/sno_vars Ljava/util/HashMap;
    aload_0
    aload_1
    ...
    aload_0
    aload_1
    invokestatic _018_apply/sno_mon_var(Ljava/lang/String;Ljava/lang/String;)V
    return
.end method
...
.method static sno_mon_var(Ljava/lang/String;Ljava/lang/String;)V
    .limit stack 6
    .limit locals 3
    getstatic _018_apply/sno_mon_fd Ljava/io/OutputStream;
    ifnull Lsmv_done
    new java/lang/StringBuilder
    dup
    invokespecial java/lang/StringBuilder/<init>()V
    ...
    getstatic _018_apply/sno_mon_go_fd Ljava/io/InputStream;
    ifnull Lsmv_done
    getstatic _018_apply/sno_mon_go_fd Ljava/io/InputStream;
