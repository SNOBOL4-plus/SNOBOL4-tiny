...
dol9_child_α:               ARB_α       r12+56, r12+64, cursor, dol9_γ ; ARB α
dol9_child_β:               ARB_β       r12+56, r12+64, cursor, subject_len_val, dol9_γ, dol9_ω ; ARB β
...
seq_l12_α:                  LIT_α1      32, r12+72, cursor, subject_data, subject_len_val, seq_r12_α, seq_l8_β ; LIT α
seq_l12_β:                  LIT_β       r12+72, cursor, seq_l8_β ; LIT β
seq_r12_α:                  SPAN_α      lit_str_2, 2, r12+80, cursor, subject_data, subject_len_val, seq_r11_α, seq_l12_β ; SPAN α
seq_r12_β:                  SPAN_β      r12+80, cursor, seq_l12_β ; SPAN β

seq_r11_α: ; DOL(WHAT $  WHAT)
                            DOL_SAVE    r12+88, cursor, dol14_child_α ; DOL α — save entry cursor
seq_r11_β:                  jmp         dol14_child_β ; DOL β
dol14_child_α:              REM_α       r12+96, cursor, subject_len_val, dol14_γ ; REM
dol14_child_β:              REM_β       r12+96, cursor, dol14_ω ; REM β
dol14_γ:                    DOL_CAPTURE r12+88, cursor, cap_WHAT_buf, cap_WHAT_len, subject_data, patdef_PAT_γ ; DOL γ — capture span
...
;  BOX DATA TEMPLATES ==================================================================================================
                            align       8
box_PAT_data_size: dq 104
box_PAT_data_template:
dq 0  ; [r12+0] = P_PAT_ret_γ
dq 0  ; [r12+8] = P_PAT_ret_ω
dq 0  ; [r12+16] = dol_entry_WHEN
dq 0  ; [r12+24] = brk4_saved
dq 0  ; [r12+32] = seq_l6_α_saved
dq 0  ; [r12+40] = span7_saved
dq 0  ; [r12+48] = dol_entry_WHO
dq 0  ; [r12+56] = arb10_start
dq 0  ; [r12+64] = arb10_step
dq 0  ; [r12+72] = seq_l12_α_saved
dq 0  ; [r12+80] = span13_saved
dq 0  ; [r12+88] = dol_entry_WHAT
dq 0  ; [r12+96] = rem15_saved
