...
; ======================================================================================================================
                            mov         edi, 2
                            call        comm_stno
                            ASSIGN_STR  S_X, S_12345abc, Ln_0
                            jmp         Ln_0
...
dol0_child_α:               SPAN_α      lit_str_1, 10, span1_saved, cursor, subject_data, subject_len_val, dol0_γ, dol0_ω ; SPAN α
dol0_child_β:               SPAN_β      span1_saved, cursor, dol0_ω ; SPAN β
...
section .data
S_X                  db 88, 0  ; "X"
S_12345abc           db 49, 50, 51, 52, 53, 97, 98, 99, 0  ; "12345abc"
S_V                  db 86, 0  ; "V"
...
S_no_SP_digits       db 110, 111, 32, 100, 105, 103, 105, 116, 115, 0  ; "no digits"
