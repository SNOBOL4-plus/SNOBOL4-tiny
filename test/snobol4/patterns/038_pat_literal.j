...
.method static <clinit>()V
    ...
    putstatic       _38_pat_literal/sno_stdout Ljava/io/PrintStream;
    iconst_0
    putstatic       _38_pat_literal/sno_kw_TRIM I
    iconst_0
    putstatic       _38_pat_literal/sno_kw_ANCHOR I
    iconst_0
    putstatic       _38_pat_literal/sno_kw_STNO I
    iconst_m1
    putstatic       _38_pat_literal/sno_kw_STLIMIT I
    iconst_0
    putstatic       _38_pat_literal/sno_kw_STCOUNT I
    new java/util/HashMap
    dup
    invokespecial java/util/HashMap/<init>()V
    putstatic       _38_pat_literal/sno_vars Ljava/util/HashMap;
    new java/util/HashMap
    dup
    invokespecial java/util/HashMap/<init>()V
    putstatic       _38_pat_literal/sno_arrays Ljava/util/HashMap;
    new java/util/HashMap
    dup
    invokespecial java/util/HashMap/<init>()V
    putstatic       _38_pat_literal/sno_data_types Ljava/util/HashMap;
    ldc             ""
    putstatic       _38_pat_literal/sno_var_X Ljava/lang/String;
    getstatic       _38_pat_literal/sno_vars Ljava/util/HashMap;
    ldc             "X"
    ldc             ""
...
.method static sno_mon_init()V
    ...
    putstatic _38_pat_literal/sno_mon_fd Ljava/io/OutputStream;
    ldc "MONITOR_GO_PIPE"
    invokestatic java/lang/System/getenv(Ljava/lang/String;)Ljava/lang/String;
    astore_1
    aload_1
    ...
    putstatic _38_pat_literal/sno_mon_go_fd Ljava/io/InputStream;
Lsmi_done:
    return
.end method
...
.method public static main([Ljava/lang/String;)V
    ...
    invokestatic _38_pat_literal/sno_mon_init()V
    getstatic _38_pat_literal/sno_kw_STNO I
    iconst_1
    iadd
    putstatic _38_pat_literal/sno_kw_STNO I
    invokestatic _38_pat_literal/sno_stcount_tick()V
    ldc "hello world"
    dup
    ifnonnull Lvar_ok_0
    pop
...
Lvar_ok_0:
    ldc "X"
    swap
    invokestatic _38_pat_literal/sno_var_put(Ljava/lang/String;Ljava/lang/String;)V
Lvar_fail_0:
    getstatic _38_pat_literal/sno_kw_STNO I
    iconst_1
    iadd
...
; --- pattern match statement ---
    ldc "X"
    invokestatic _38_pat_literal/sno_indr_get(Ljava/lang/String;)Ljava/lang/String;
    astore 6
    iconst_0
    istore 7
    aload 6
...
Jpat0_tok:
    goto Jpat0_success
Jpat0_tfail:
    getstatic _38_pat_literal/sno_kw_ANCHOR I
    ifeq Jpat0_askip
    goto Jpat0_fail
Jpat0_askip:
    iinc 7 1
...
L_YES:
    ...
    goto Lout_fail_0
Lout_ok_0:
    getstatic _38_pat_literal/sno_stdout Ljava/io/PrintStream;
    swap
...
Lkwg_not_stno:
    ...
    invokevirtual java/lang/String/equalsIgnoreCase(Ljava/lang/String;)Z
    ifeq Lkwg_not_trim
    getstatic _38_pat_literal/sno_kw_TRIM I
    invokestatic java/lang/Integer/toString(I)Ljava/lang/String;
    areturn
Lkwg_not_trim:
    aload_0
...
Lkwg_not_anchor:
    ...
    getstatic _38_pat_literal/sno_kw_STLIMIT I
    invokestatic java/lang/Integer/toString(I)Ljava/lang/String;
    areturn
Lkwg_not_stlimit:
    aload_0
    ...
    getstatic _38_pat_literal/sno_kw_STCOUNT I
    invokestatic java/lang/Integer/toString(I)Ljava/lang/String;
    areturn
Lkwg_not_stcount:
    ldc ""
...
Lsvp_not_output:
    ...
    aload_0
    aload_1
    invokestatic _38_pat_literal/sno_mon_var(Ljava/lang/String;Ljava/lang/String;)V
    return
.end method
...
.method static sno_mon_var(Ljava/lang/String;Ljava/lang/String;)V
    .limit stack 6
    .limit locals 3
    getstatic _38_pat_literal/sno_mon_fd Ljava/io/OutputStream;
    ifnull Lsmv_done
    new java/lang/StringBuilder
    dup
    invokespecial java/lang/StringBuilder/<init>()V
    ...
    getstatic _38_pat_literal/sno_mon_go_fd Ljava/io/InputStream;
    ifnull Lsmv_done
    getstatic _38_pat_literal/sno_mon_go_fd Ljava/io/InputStream;
