...
.class public _76_builtin_ident
...
.method static <clinit>()V
    ...
    putstatic       _76_builtin_ident/sno_stdout Ljava/io/PrintStream;
    iconst_0
    putstatic       _76_builtin_ident/sno_kw_TRIM I
    iconst_0
    putstatic       _76_builtin_ident/sno_kw_ANCHOR I
    iconst_0
    putstatic       _76_builtin_ident/sno_kw_STNO I
    iconst_m1
    putstatic       _76_builtin_ident/sno_kw_STLIMIT I
    iconst_0
    putstatic       _76_builtin_ident/sno_kw_STCOUNT I
    new java/util/HashMap
    dup
    invokespecial java/util/HashMap/<init>()V
    putstatic       _76_builtin_ident/sno_vars Ljava/util/HashMap;
    new java/util/HashMap
    dup
    invokespecial java/util/HashMap/<init>()V
    putstatic       _76_builtin_ident/sno_arrays Ljava/util/HashMap;
    new java/util/HashMap
    dup
    invokespecial java/util/HashMap/<init>()V
    putstatic       _76_builtin_ident/sno_data_types Ljava/util/HashMap;
    return
.end method
...
.method static sno_mon_init()V
    ...
    putstatic _76_builtin_ident/sno_mon_fd Ljava/io/OutputStream;
    ldc "MONITOR_GO_PIPE"
    invokestatic java/lang/System/getenv(Ljava/lang/String;)Ljava/lang/String;
    astore_1
    aload_1
    ...
    putstatic _76_builtin_ident/sno_mon_go_fd Ljava/io/InputStream;
Lsmi_done:
    return
.end method
...
.method public static main([Ljava/lang/String;)V
    ...
    invokestatic _76_builtin_ident/sno_mon_init()V
    getstatic _76_builtin_ident/sno_kw_STNO I
    iconst_1
    iadd
    putstatic _76_builtin_ident/sno_kw_STNO I
    invokestatic _76_builtin_ident/sno_stcount_tick()V
    ldc "abc"
    dup
...
L_YES:
    ...
    goto Lout_fail_0
Lout_ok_0:
    getstatic _76_builtin_ident/sno_stdout Ljava/io/PrintStream;
    swap
...
Lkwg_not_stno:
    ...
    invokevirtual java/lang/String/equalsIgnoreCase(Ljava/lang/String;)Z
    ifeq Lkwg_not_trim
    getstatic _76_builtin_ident/sno_kw_TRIM I
    invokestatic java/lang/Integer/toString(I)Ljava/lang/String;
    areturn
Lkwg_not_trim:
    aload_0
    ...
    getstatic _76_builtin_ident/sno_kw_ANCHOR I
    invokestatic java/lang/Integer/toString(I)Ljava/lang/String;
    areturn
Lkwg_not_anchor:
    aload_0
    ...
    getstatic _76_builtin_ident/sno_kw_STLIMIT I
    invokestatic java/lang/Integer/toString(I)Ljava/lang/String;
    areturn
Lkwg_not_stlimit:
    aload_0
    ...
    getstatic _76_builtin_ident/sno_kw_STCOUNT I
    invokestatic java/lang/Integer/toString(I)Ljava/lang/String;
    areturn
Lkwg_not_stcount:
    ldc ""
...
.method static sno_var_put(Ljava/lang/String;Ljava/lang/String;)V
    ...
    return
Lsvp_not_output:
    getstatic _76_builtin_ident/sno_vars Ljava/util/HashMap;
    aload_0
    aload_1
    ...
    aload_0
    aload_1
    invokestatic _76_builtin_ident/sno_mon_var(Ljava/lang/String;Ljava/lang/String;)V
    return
.end method
...
.method static sno_mon_var(Ljava/lang/String;Ljava/lang/String;)V
    .limit stack 6
    .limit locals 3
    getstatic _76_builtin_ident/sno_mon_fd Ljava/io/OutputStream;
    ifnull Lsmv_done
    new java/lang/StringBuilder
    dup
    invokespecial java/lang/StringBuilder/<init>()V
    ...
    getstatic _76_builtin_ident/sno_mon_go_fd Ljava/io/InputStream;
    ifnull Lsmv_done
    getstatic _76_builtin_ident/sno_mon_go_fd Ljava/io/InputStream;
